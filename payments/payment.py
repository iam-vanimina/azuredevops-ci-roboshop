...
CART = os.getenv('CART_HOST', 'CART_HOST')
CART_PORT = os.getenv('CART_PORT', 'CART_PORT')
USER = os.getenv('USER_HOST', 'USER_HOST')
USER_PORT = os.getenv('USER_PORT', 'USER_PORT')
#PAYMENT_GATEWAY = os.getenv('PAYMENT_GATEWAY', 'PAYMENT_GATEWAY')
